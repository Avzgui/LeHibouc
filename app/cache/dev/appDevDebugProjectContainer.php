...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AppBundle', ($this->targetDirs[2].'/Resources/AppBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AppBundle', ($this->targetDirs[3].'/src/LeHibouc/AppBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EBookLibraryBundle', ($this->targetDirs[2].'/Resources/EBookLibraryBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EBookLibraryBundle', ($this->targetDirs[3].'/src/LeHibouc/EBookLibraryBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KtbsBundle', ($this->targetDirs[2].'/Resources/KtbsBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KtbsBundle', ($this->targetDirs[3].'/src/LeHibouc/KtbsBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_aa11d7b9647018704a3df411644ed84ea510cd8c10569f8e839f7113ebf9eea8');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/LeHibouc/AppBundle/Resources/views'), 'App');
        $instance->addPath(($this->targetDirs[3].'/src/LeHibouc/EBookLibraryBundle/Resources/views'), 'EBookLibrary');
        $instance->addPath(($this->targetDirs[3].'/src/LeHibouc/KtbsBundle/Resources/views'), 'Ktbs');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('567b21ce06b427.96115901')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AppBundle' => 'LeHibouc\\AppBundle\\AppBundle',
                'EBookLibraryBundle' => 'LeHibouc\\EBookLibraryBundle\\EBookLibraryBundle',
                'KtbsBundle' => 'LeHibouc\\KtbsBundle\\KtbsBundle',
